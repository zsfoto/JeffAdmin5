...
?>
	...
	if(isset($config['header_buttons_in_action'][$action]["back"]) && $config['header_buttons_in_action'][$action]["back"]){
	...
	if(isset($config['header_buttons_in_action'][$action]["save"]) && $config['header_buttons_in_action'][$action]["save"]){
	...
	if(isset($config['header_buttons_in_action'][$action]["add"]) && $config['header_buttons_in_action'][$action]["add"]){
	...
	if(isset($config['header_buttons_in_action'][$action]["edit"]) && $config['header_buttons_in_action'][$action]["edit"]){
	...
	if(isset($config['header_buttons_in_action'][$action]["view"]) && $config['header_buttons_in_action'][$action]["view"]){
	...
	// floar-end
	if(isset($config['header_buttons_in_action'][$action]["delete"]) && $config['header_buttons_in_action'][$action]["delete"]){
